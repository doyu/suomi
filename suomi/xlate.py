...
# %% ../nbs/00a_xlate.ipynb 2
import json
import time
from openai import OpenAI

# %% ../nbs/00a_xlate.ipynb 4
def _call(
...
def call(
    ...
    for attempt in range(max_retries):
        try:
            return _call(cli, msgs=msgs, model=model)
